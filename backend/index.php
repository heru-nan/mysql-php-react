...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($existingvotos['exists']) {
        ...
        $json = add_votos_info($alias, $candidato, $comoSeEntero, $email, $fullName, $rut, $region, $comuna);
        echo json_encode($json);
    }
}
...
if ($_SERVER['REQUEST_METHOD'] == "PUT") {
    ...
    // $json = update_votos_info($id, $alias, $candidato, $comoSeEntero, $email, $fullName, $rut, $region, $comuna);
    // echo json_encode($json);
}
